...
To optimize the hbinsDatabasePlatform application for production, run:
...
Then navigate to [http://localhost:9701](http://localhost:9701) in your browser.
